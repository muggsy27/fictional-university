        ...
        <ul class="min-list link-list" id="my-notes">
            ...
            ?>
                <li data-id="<?php the_ID(); ?>">
                    ...
                    <span class="delete-note"><i class="fa fa-dash-trash-o" aria-hidden="true"></i> Delete</span>
                    <textarea readonly class="note-body-field"><?php echo esc_attr(wp_strip_all_tags(get_the_content())); ?></textarea>
                    <span class="update-note btn btn--blue btn--small"><i class="fa fa-dash-arrow-right" aria-hidden="true"></i> Save</span>
                </li>
            <?php
            }
            ?>
